...
app.get("/filter", (req,res)=>{
  const type = req.query.type; //prendi i query params
  const foundJokeBasedOnType =  jokes.filter(el=>el.jokeType ===type) //filter perche' ritorna un'array di oggetti che matchano le condizioni
  res.json(foundJokeBasedOnType)
})
